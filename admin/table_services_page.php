...
<div id="content-wrapper" class="d-flex flex-column">
          ...
          <table class="table table-bordered" id="titleTable" width="100%" cellspacing="0">
            ...
            <tbody>
              ...
              foreach ($servicesPageObject as $serviceTitleAndParagraph) {
                ?>
                <tr>
                  <td><?php echo $serviceTitleAndParagraph->getTitle(); ?></td>
                  <td>
                    <!-- Update title -->
                    <button type="button" id="updateTitleButton" class="updateButton btn-primary btn-icon-split"
                    data-id="<?php echo $serviceTitleAndParagraph->getId(); ?>"
                    data-paragraph="<?php echo $serviceTitleAndParagraph->getParagraph(); ?>">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary text-center">Paragraph of the Services section</h6>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        <table class="table table-bordered" id="titleTable" width="100%" cellspacing="0">
          ...
          <tbody>
            ...
            foreach ($servicesPageObject as $serviceTitleAndParagraph) {
              ?>
              <tr>
                <td><?php echo $serviceTitleAndParagraph->getParagraph(); ?></td>
                <td>
                  <!-- Update paragraph -->
...
<div class="card shadow mb-4">
      ...
      <table class="table table-bordered" id="servicesTable" width="100%" cellspacing="0">
        ...
        <tbody>
          ...
          foreach ($servicesList as $singleService) {
            ...
            <tr>
              <td>
                <form method="post" action="../controllers/services-controller.php">
              ...
              if (isset($_SESSION['access_level'])) {
                ...
                if ($accessLevel == 1) {
                  ?>
                  <form method="post" action="../controllers/services-controller.php" onsubmit="return confirmDelete();">
  ...
  <!-- MODAL - Update the paragraph of the service section -->
  <div id="updateParagraphModal" class="modal">
    <div class="modal-content">
      ...
      <form method="post" action="../controllers/services-controller.php">
        ...
        <br>
        <input type="hidden" name="action" value="update_paragraph_services">
        <button type="submit" class="btn btn-primary">Update Title</button>
      </form>
    </div>
  </div>
