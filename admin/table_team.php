   ...
   <div class="container-fluid">
    ...
    <div class="card shadow mb-4">
      <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary text-center">Title of the Team Section</h6>
      </div>
      <div class="card-body">
        <div class="table-responsive">
          <table class="table table-bordered" id="titleTable" width="100%" cellspacing="0">
            ...
            <tbody>
              <!-- Display the title -->
              <?php
              $allTitles = $TeamManager->getAllTeamTitle();
              
              foreach ($allTitles as $title) {
                ?>
                <tr>
                  <td><?php echo $title->getTitle(); ?></td>
                  <td>
                    <!-- Update title -->
                    <button type="button" id="updateTitleButton" class="updateButton btn-primary btn-icon-split"
                    data-id="<?php echo $title->getId(); ?>"
                    data-title="<?php echo $title->getTitle(); ?>">
      ...
      <div id="updateTitleModal" class="modal">
        <div class="modal-content">
          ...
          <form method="post" action="../controllers/home-controller.php">
            ...
            <br>
            <input type="hidden" name="action" value="update_title_team">
