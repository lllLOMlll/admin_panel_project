...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <div id="content">
   ...
   <!-- Begin Page Content -->
   <!-- SESSION VARIABLE FOR THE HOME-CONTROLLER -->
   <?php 
   $_SESSION['table_portfolio_page'] = true;
   ?>
   <div class="container-fluid">
    ...
    ?>
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Portfolio Page</h1>
          ...
          <table class="table table-bordered" id="titleTable" width="100%" cellspacing="0">
            ...
            <tbody>
              ...
              foreach ($portfolioTitleAndParagraph as $titleAndParagraph) {
                ?>
                <tr>
                  <td><?php echo $titleAndParagraph->getTitle(); ?></td>
                  <td>
                    <!-- Update title -->
                    <button type="button" id="updateTitleButton" class="updateButton btn-primary btn-icon-split"
                    data-id="<?php echo $titleAndParagraph->getId(); ?>"
                    data-title="<?php echo $titleAndParagraph->getTitle(); ?>">
  ...
  <!-- PARAGRAPH OF THE PORTFOLIO SECTION -->
  <div class="card shadow mb-4">
    <div class="card-header py-3">
        ...
        <table class="table table-bordered" id="titleTable" width="100%" cellspacing="0">
          ...
          <tbody>
            ...
            foreach ($portfolioTitleAndParagraph as $titleAndParagraph) {
              ?>
              <tr>
                <td><?php echo $titleAndParagraph->getParagraph(); ?></td>
                <td>
                  <!-- Update title -->
                  <button type="button" id="updateParagraphButton" class="updateButton btn-primary btn-icon-split"
                  data-id="<?php echo $titleAndParagraph->getId(); ?>"
                  data-paragraph="<?php echo $titleAndParagraph->getParagraph(); ?>">
                  <span class="icon text-white-50">
                    <i class="fas fa-flag"></i>
                  </span>
  ...
  <div class="card-body">
    ...
    <div id="updateTitleModal" class="modal">
      <div class="modal-content">
        ...
        <form method="post" action="../controllers/portfolio-controller.php">
...
updateParagraphButton.addEventListener("click", function() {
  ...
  updateParagraphModalElement.style.display = "block";
});
